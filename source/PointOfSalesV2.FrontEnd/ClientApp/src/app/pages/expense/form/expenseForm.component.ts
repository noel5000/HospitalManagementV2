...
export class ExpenseFormComponent extends BaseComponent implements OnInit {
    ...
    suppliers:Supplier[]=[];//
    taxes:Tax[]=[];//
    expenseTaxService:BaseService<any,number>;
    ...
    constructor(@Inject('BASE_URL') private baseUrl: string,
      ...
      private  http: HttpClient
            ...
            super(route, langService, AppRoles.Expenses_Registers,modalService);
            this.expenseTaxService= new BaseService<any,number>(this.http, `${this.baseUrl}api/expenseTax`);
