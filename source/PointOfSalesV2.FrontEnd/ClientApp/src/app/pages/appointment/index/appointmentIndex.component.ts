...
import {  ObjectTypes, QueryFilter, BillingStatesColors, AppRoles, Operations } from '../../../@core/common/enums';
...
export class appointmentIndexComponent extends BaseComponent implements OnInit {
  ...
  hospitalService: BaseService<any, number>;
  medicalSpecialitiesService: BaseService<any, number>;
  doctorService: BaseService<any, number>;
  patientsService: BaseService<any, number>;
  ...
  constructor(@Inject('BASE_URL') private baseUrl: string,
    ...
    this.service = new BaseService<any, number>(this.http, `${this.baseUrl}api/Appointment`);
    this.hospitalService = new BaseService<any, number>(this.http, `${this.baseUrl}api/branchoffice`);
    this.medicalSpecialitiesService= new BaseService<any, number>(this.http, `${this.baseUrl}api/medicalSpeciality`);
    this.doctorService = new BaseService<any, number>(this.http, `${this.baseUrl}api/user`);
    this.patientsService = new BaseService<any, number>(this.http, `${this.baseUrl}api/Customer`);
      ...
      !form.type ? 'NA' : form.type]).subscribe(r => {
        ...
        this.appointments.forEach(d => {
          this.events.push({
            ...
            color: (BillingStatesColors as any)[d.state],
