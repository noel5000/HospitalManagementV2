...
quantity:[0,[ Validators.required,Validators.min(0.0001)]],
       ...
       this.warehouseTransferService = new BaseService<any,number>(this.http, `${this.baseUrl}api/WarehouseTransfer`);
       ...
       this.productSearch = new AutoCompleteComponent(this.baseUrl, this.http, changes);
    }
  ...
  product: Product | null = null;
    ...
    warehouseTransferService:BaseService<any,number>;
