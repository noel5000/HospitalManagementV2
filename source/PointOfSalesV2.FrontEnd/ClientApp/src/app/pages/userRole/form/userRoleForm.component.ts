...
export class UserRoleFormComponent extends BaseComponent implements OnInit {
    ...
    userRoles:any[]=[];
    roles:any[]=[];
    userRoleService:BaseService<any,number>;
    userService:BaseService<any,string>;
    ...
    constructor(@Inject('BASE_URL') private baseUrl: string,
      ...
      private  http: HttpClient
        ...
        this.userRoleService= new BaseService<any,number>(this.http, `${this.baseUrl}api/userRole`);
        this.userService= new BaseService<any,string>(this.http,`${this.baseUrl}api/user`);
