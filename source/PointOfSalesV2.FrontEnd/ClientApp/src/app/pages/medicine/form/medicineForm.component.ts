...
export class MedicineFormComponent extends BaseComponent implements OnInit {
    ...
    productSupCostService:BaseService<any,number>;
    baseProductsService:BaseService<any,number>;
    ...
    constructor(@Inject('BASE_URL') private baseUrl: string,
      ...
      private  http: HttpClient
            ...
            this.productSupCostService= new BaseService<any,number>(this.http,`${this.baseUrl}api/ProductCost`);
            this.baseProductsService= new BaseService<any,number>(this.http,`${this.baseUrl}api/CompositeProduct`);
           ...
           this.setProductChildren();
            ...
            subscription.subscribe(r=>{
               if(r.status>=0){
                ...
                this.router.navigateByUrl('pages/medicine');
               }
               else
