...
export class CashRegisterOpeningFormComponent extends BaseComponent implements OnInit {
    ...
    service:BaseService<CashRegisterOpening,number>;
    closureService:BaseService<CashRegisterOpening,number>;
    detailsService:BaseService<any,number>;
    ...
    constructor(@Inject('BASE_URL') private baseUrl: string,
       ...
       modalService:ModalService
            ...
            this.service=new BaseService<CashRegisterOpening,number>(this.http, `${this.baseUrl}api/CashRegisterOpening`);
            this.closureService=new BaseService<CashRegisterOpening,number>(this.http, `${this.baseUrl}api/CashRegisterOpening/CloseCashRegister`);
            this.detailsService=new BaseService<any,number>(this.http, `${this.baseUrl}api/CashRegisterOpeningDetail`);
            this._route=router;
    ...
    override onChanges(): void {
      ...
      this.getUsers(id);
        ...
        if(!isNaN(val.currencyId) && parseInt(val.currencyId)>0){
            ...
            this.currentCurrency=currency ? currency : null;
