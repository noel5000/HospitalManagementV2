...
export class insuranceCoverageFormComponent extends BaseComponent implements OnInit {
    ...
    insurancePlanService:BaseService<any,number>;
    productService:BaseService<any,number>;
    ...
    constructor(@Inject('BASE_URL') private baseUrl: string,
       ...
       modalService:ModalService
            ...
            this.service= new BaseService<any,number>(this.http, `${this.baseUrl}api/InsuranceServiceCoverage`);
            this.insuranceService= new BaseService<any,number>(this.http, `${this.baseUrl}api/Insurance`);
            this.insurancePlanService= new BaseService<any,number>(this.http, `${this.baseUrl}api/InsurancePlan`);
            this.productService= new BaseService<any,number>(this.http, `${this.baseUrl}api/Product`);
