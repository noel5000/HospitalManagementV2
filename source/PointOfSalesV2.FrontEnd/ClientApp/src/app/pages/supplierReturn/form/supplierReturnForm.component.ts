...
export class SupplierReturnFormComponent extends BaseComponent implements OnInit {
  ...
  SupplierReturnService: BaseService<any, number>;
  productUnitService: BaseService<any, number>;
  productCostService: BaseService<any, number>;
  ...
  constructor(@Inject('BASE_URL') private baseUrl: string,
    ...
    this.productSearch = new AutoCompleteComponent(this.baseUrl, this.http, change );
    this.SupplierReturnService = new BaseService<any, number>(this.http, `${this.baseUrl}api/SupplierReturn`);
    this.productUnitService = new BaseService<any, number>(this.http, `${this.baseUrl}api/ProductUnit`);
    this.productCostService = new BaseService<any, number>(this.http, `${this.baseUrl}api/ProductCost`);
  ...
  addEntry() {
    ...
    entry.warehouse = this.warehouses.find((x:any) => x.id == entry.warehouseId);
    entry.unit = this.productUnits.find((x:any) => x.unitId == entry.unitId).unit;
    ...
    this.originInventory = { currentUnitEquivalence :0, id:0,quantity:0};
    this.itemForm.patchValue({
      unitId: null,
      productId: null,
      quantity: 0,
