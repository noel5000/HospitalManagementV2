        ...
        public override async Task<Result<Appointment>> GetAsync(long id)
        {
            var item = await this._Context.Appointments.AsNoTracking().Include(x => x.Hospital)
                 ...
                 .Select(x => new Appointment()
                 {
                     ...
                     InsuranceName = (x.InsuranceId.HasValue && x.Insurance!=null ? x.Insurance.Name : ""),
                     InsurancePlanId = x.InsurancePlanId,
                     InsurancePlanName = (x.InsurancePlanId.HasValue && x.InsurancePlan!=null ? x.InsurancePlan.Name : ""),
                     CurrencyName = x.Currency!=null?x.Currency.Name:String.Empty,
                     HospitalName = x.Hospital!=null?x.Hospital.Name : String.Empty,
            ...
            item.Details = await _Context.AppointmentDetails.AsNoTracking()
                ...
                .Include(x => x.Currency).Where(x => x.Active == true && x.AppointmentId == id).Select(d => new AppointmentDetail()
                {
                    ...
                    MedicalSpecialityName = (d.MedicalSpecialityId.HasValue &&d.MedicalSpeciality!=null ? d.MedicalSpeciality.Name : ""),
                    SpecialityName = (d.MedicalSpecialityId.HasValue && d.MedicalSpeciality!=null ? d.MedicalSpeciality.Name : ""),
                    ProductName = (d.Product != null ? d.Product.Name : ""),
                    Type = d.Type,
                    ProductId = d.ProductId,
                    CurrencyName = d.Currency!=null?d.Currency.Name : String.Empty,
                    Doctor = d.Doctor,
